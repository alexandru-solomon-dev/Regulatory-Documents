...
- При именовании папок и файлов используйте только латинские буквы, цифры, пробелы, `-` и `_`.  
- Избегайте использование нескольких спец символов подряд, за исключением дефиса отделенного пробелами (`File - 1`).
...
- Допустимы различные стили именования для разных типов файлов.  
