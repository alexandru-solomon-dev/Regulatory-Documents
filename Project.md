...
Например, это может быть максимальный уровень игрока, таблица/прогрессия для опыта необходимого чтобы перейти на новый уровень. Базовые параметры монстров до учета сложности, а так же влияние этих множителей сложности игры и многое другое.  
