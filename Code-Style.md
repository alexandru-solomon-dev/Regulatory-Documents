...
- Между `List<T>` и массивом, предпочитайте массив.
...
В качестве публичного поля или свойства отдайте предпочтение наиболее ограничивающему варианту. Например, `IReadOnlyCollection`.
