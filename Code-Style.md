...
При реализации интерфейса или при наследовании класса нет необходимости писать комментарии для публичных членов, если для них уже был оставлен комментарий. 
